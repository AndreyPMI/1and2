...
В заключении стоит отметить, что с уменьшением стандартного отклонения белого шума уменьшилось понизилась MSE, что выглядит крайне логично, так как разброс белого шума повышает общую дисперсию функции. 